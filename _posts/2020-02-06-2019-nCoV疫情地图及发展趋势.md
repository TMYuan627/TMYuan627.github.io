...
查阅了几篇资料后，采用Python获取网页后台疫情数据+pyecharts库进行数据可视化来实现。代码请接着往下看。

每编译一次py文件，会发布一个由最新疫情数据绘制的html页面。

由于Github+Jekyll搭建的博客仅支持静态页面，暂无法实现html页面数据的自动刷新。只能人工定时编译py文件后上传html页面至服务器。

html页面内绘制了全国总量、昨日新增饼图，中国疫情、世界疫情地图，每日新增趋势柱状图，确诊与疑似、治愈与死亡趋势折线图。
...
<body>
    <style>.box {  }; </style>
    <div class="box">
                <div id="36c0ba7c76d84d30a3e139d6765eb846" class="chart-container" style="width:500px; height:350px;"></div>
    <script>
        var chart_36c0ba7c76d84d30a3e139d6765eb846 = echarts.init(
            document.getElementById('36c0ba7c76d84d30a3e139d6765eb846'), 'westeros', {renderer: 'canvas'});
        var option_36c0ba7c76d84d30a3e139d6765eb846 = {
    "animation": true,
    ...
    "title": [
        {
            "text": "\u5168\u56fd\u603b\u91cf",
            "subtext": "\u622a\u6b622020-02-06 14:12:51",
            "padding": 5,
            "itemGap": 10
        }
    ]
};
        chart_36c0ba7c76d84d30a3e139d6765eb846.setOption(option_36c0ba7c76d84d30a3e139d6765eb846);
    </script>
<br/>                <div id="b913a8cead4f4b9d8febf543ba415b22" class="chart-container" style="width:500px; height:350px;"></div>
    <script>
        var chart_b913a8cead4f4b9d8febf543ba415b22 = echarts.init(
            document.getElementById('b913a8cead4f4b9d8febf543ba415b22'), 'westeros', {renderer: 'canvas'});
        var option_b913a8cead4f4b9d8febf543ba415b22 = {
    "animation": true,
    "animationThreshold": 2000,
    "animationDuration": 1000,
    "animationEasing": "cubicOut",
    ...
    "title": [
        ...
        chart_b913a8cead4f4b9d8febf543ba415b22.setOption(option_b913a8cead4f4b9d8febf543ba415b22);
    </script>
<br/>                <div id="add72129c9fc49a0bee45433718c240f" class="chart-container" style="width:900px; height:500px;"></div>
    <script>
        var chart_add72129c9fc49a0bee45433718c240f = echarts.init(
            document.getElementById('add72129c9fc49a0bee45433718c240f'), 'westeros', {renderer: 'canvas'});
        var option_add72129c9fc49a0bee45433718c240f = {
    "animation": true,
    "animationThreshold": 2000,
    "animationDuration": 1000,
    "animationEasing": "cubicOut",
    ...
    "visualMap": {
        ...
        chart_add72129c9fc49a0bee45433718c240f.setOption(option_add72129c9fc49a0bee45433718c240f);
    </script>
<br/>                <div id="e6ca86d07fc54a8e8960de93c8294547" class="chart-container" style="width:900px; height:500px;"></div>
    <script>
        var chart_e6ca86d07fc54a8e8960de93c8294547 = echarts.init(
            document.getElementById('e6ca86d07fc54a8e8960de93c8294547'), 'westeros', {renderer: 'canvas'});
        var option_e6ca86d07fc54a8e8960de93c8294547 = {
    "animation": true,
    "animationThreshold": 2000,
    "animationDuration": 1000,
    "animationEasing": "cubicOut",
    ...
    "visualMap": {
        ...
        chart_e6ca86d07fc54a8e8960de93c8294547.setOption(option_e6ca86d07fc54a8e8960de93c8294547);
    </script>
<br/>                <div id="828477f0511245678c57adee29d7140e" class="chart-container" style="width:900px; height:400px;"></div>
    <script>
        var chart_828477f0511245678c57adee29d7140e = echarts.init(
            document.getElementById('828477f0511245678c57adee29d7140e'), 'westeros', {renderer: 'canvas'});
        var option_828477f0511245678c57adee29d7140e = {
    "animation": true,
    "animationThreshold": 2000,
    "animationDuration": 1000,
    "animationEasing": "cubicOut",
    ...
    "title": [
        ...
        chart_828477f0511245678c57adee29d7140e.setOption(option_828477f0511245678c57adee29d7140e);
    </script>
<br/>                <div id="8be2c07c4e5f47d8bd8c36031145c52d" class="chart-container" style="width:900px; height:500px;"></div>
    <script>
        var chart_8be2c07c4e5f47d8bd8c36031145c52d = echarts.init(
            document.getElementById('8be2c07c4e5f47d8bd8c36031145c52d'), 'westeros', {renderer: 'canvas'});
        var option_8be2c07c4e5f47d8bd8c36031145c52d = {
    "animation": true,
    "animationThreshold": 2000,
    "animationDuration": 1000,
    "animationEasing": "cubicOut",
    ...
    "title": [
        ...
        chart_8be2c07c4e5f47d8bd8c36031145c52d.setOption(option_8be2c07c4e5f47d8bd8c36031145c52d);
    </script>
<br/>                <div id="9beb40e7009c4465b9d83c798a8b6335" class="chart-container" style="width:900px; height:500px;"></div>
    <script>
        var chart_9beb40e7009c4465b9d83c798a8b6335 = echarts.init(
            document.getElementById('9beb40e7009c4465b9d83c798a8b6335'), 'westeros', {renderer: 'canvas'});
        var option_9beb40e7009c4465b9d83c798a8b6335 = {
    "animation": true,
    "animationThreshold": 2000,
    "animationDuration": 1000,
    "animationEasing": "cubicOut",
    ...
    "title": [
        ...
        chart_9beb40e7009c4465b9d83c798a8b6335.setOption(option_9beb40e7009c4465b9d83c798a8b6335);
    </script>
<br/>    </div>
    <script>
    </script>
...
# 一 网页分析
首先进入数据源网站[腾讯疫情实时追踪](https://news.qq.com/zt2020/page/feiyan.htm?from=timeline&isappinstalled=0)，按F12进入开发者工具并刷新（以Chrome浏览器为例），点击`Network`。
...
- 请在`Manage Repositories`中的镜像更换为国内镜像。（梯子倒了的我用起来非常难受）
- 在安装其他库之前，先把pip升级，点击`Install Package`前勾选右边的`Specify version`，否则会安装失败。
