...
<body style="height: 100%; margin: 10"></body>

<body>
    <div id="1" style="width: 50%;"></div>
    <script type="text/javascript">
    var container1 = document.getElementById('1');
    var sizecontainer1 = function () {
        container1.style.width = window.innerWidth+'%';
        container1.style.height = window.innerHeight+'%';
};
