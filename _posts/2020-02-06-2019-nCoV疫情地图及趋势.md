...
<div id="3" style="width: 900px;height:500px;"></div>
<script type="text/javascript">
var container3 = document.getElementById('3');
var sizecontainer3 = function () {
    if (window.innerWidth>500) {
            container3.style.width = window.innerWidth*0.3*+'px';
            container3.style.height = window.innerHeight*0.3*+'px';
        } else {
...
<div id="4" style="width: 900px;height:500px;"></div>
<script type="text/javascript">
var container4 = document.getElementById('4');
var sizecontainer4 = function () {
    if (window.innerWidth>500) {
            container4.style.width = window.innerWidth*0.3*+'px';
            container4.style.height = window.innerHeight*0.3*+'px';
        } else {
...
<div id="5" style="width: 900px;height:400px;"></div>
<script type="text/javascript">
var container5 = document.getElementById('5');
var sizecontainer5 = function () {
    if (window.innerWidth>500) {
            container5.style.width = window.innerWidth*0.3*+'px';
            container5.style.height = window.innerHeight*0.3*+'px';
        } else {
...
<div id="6" style="width: 900px;height:400px;"></div>
<script type="text/javascript">
var container6 = document.getElementById('6');
var sizecontainer6 = function () {
     if (window.innerWidth>500) {
            container6.style.width = window.innerWidth*0.3*+'px';
            container6.style.height = window.innerHeight*0.3*+'px';
        } else {
...
<div id="7" style="width: 900px;height:500px;"></div>
<script type="text/javascript">
var container7 = document.getElementById('7');
var sizecontainer7 = function () {
     if (window.innerWidth>500) {
            container7.style.width = window.innerWidth*0.3*+'px';
            container7.style.height = window.innerHeight*0.3*+'px';
        } else {
