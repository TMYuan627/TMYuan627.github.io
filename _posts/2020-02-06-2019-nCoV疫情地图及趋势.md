...
var sizecontainer3 = function () {
    if (window.innerWidth>500) {
            container3.style.width = window.innerWidth*0.5*+'px';
            container3.style.height = window.innerHeight*0.5*+'px';
        } else {
...
var sizecontainer4 = function () {
    if (window.innerWidth>500) {
            container4.style.width = window.innerWidth*0.5*+'px';
            container4.style.height = window.innerHeight*0.5*+'px';
        } else {
...
var sizecontainer5 = function () {
    if (window.innerWidth>500) {
            container5.style.width = window.innerWidth*0.5*+'px';
            container5.style.height = window.innerHeight*0.5*+'px';
        } else {
...
var sizecontainer6 = function () {
     if (window.innerWidth>500) {
            container6.style.width = window.innerWidth*0.5*+'px';
            container6.style.height = window.innerHeight*0.5*+'px';
        } else {
...
var sizecontainer7 = function () {
     if (window.innerWidth>500) {
            container7.style.width = window.innerWidth*0.5*+'px';
            container7.style.height = window.innerHeight*0.5*+'px';
        } else {
